#!/bin/bash
#SBATCH --job-name=CompletelyNormal
...
outdir=$GROUP_SCRATCH/simulations/results/07_15_24/CompletelyNormal/$SLURM_JOB_ID
mkdir -p $outdir

# Specify the Python script path
pyscript=$HOME/scripts/07_15_24/07_15_24.py
