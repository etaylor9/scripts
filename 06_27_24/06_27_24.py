...
# File Info: 
    ...
    # Goals for this file: 
    #         - filling factor of 1/10 * (1/3) --> currious about what this would look like 
    #         - print the spacing between islands and the island width 
    #         - make the plaquette a rhombus
...
p2 = (r0_list[20][0], r0_list[20][1])
p3 = (r0_list[38][0], r0_list[38][1]) 
p4 =  (r0_list[19][0], r0_list[19][1]) 
...
dist_btw_island = distance(p1,p3)
print(f"Island Size: {width_island:.0f} nm")
print(f"Island Spacing: {dist_btw_island:.0f} nm")
