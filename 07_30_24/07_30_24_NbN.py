# -------------------------------- #
# File Info: July 30th, 2024
    # Goals for this file: 
    #     - range of london penetration depths lengths ("50" "100" "200" "300")
...
print(f'Simulating for london lambda = {london_lambda} nm and filling factor f = {f:.2f} ')
