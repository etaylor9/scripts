...
def make_video_from_solution(
    ...
    save_path = os.path.join(save_dir, fr'{solution_type}{f}.mp4')
...
zeroExcitation_solution_path = os.path.join(file_path, f'fullevolution_orderParameter{f:.2}.png')
fig.savefig(zeroExcitation_solution_path)

fig, ax = zeroExcitation_solution.plot_currents()
zeroExcitation_solution_path = os.path.join(file_path, f'fullevolution_current{f:.2}.png')
fig.savefig(zeroExcitation_solution_path)
