...
plot_save_path = os.path.join(file_path, f'epsilon_distribution_noPP_{f:.2f}.png')
...
zeroExcitation_solution_path = os.path.join(file_path, f'final_solution{f:.2f}.png')
