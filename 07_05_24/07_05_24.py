...
# File Info: 
    ...
    #     - increase distance between islands 
    #     - increase run time solve time from 600 --> 900 
    #     - include f = 1/4 (optimal for triangular lattices, taken from: https://journals.aps.org/prb/pdf/10.1103/PhysRevB.54.10081)
...
step_x = 500 + width_island # nm
step_y = 500 + width_island # nm
center = (0, 0)
...
p3 = (r0_list[18][0], r0_list[18][1]) 
p4 =  (r0_list[17][0], r0_list[17][1]) 
...
options = tdgl.SolverOptions(
    ...
    current_units="uA",
    field_units="mT",
    output_file=os.path.join(file_path, f"data_{f:.2f}.h5"),
)
