...
def make_video_from_solution(
    ...
    save_path = os.path.join(save_dir, f'solution_video_{f:.2f}_{london_lambda}.mp4')
...
order_parameter_path = os.path.join(file_path, f'order_parameter_sym_{f:.2f}_{london_lambda}.png')
fig , ax = excitation_solution.plot_order_parameter()
fig.savefig(order_parameter_path)


fig, ax = excitation_solution.plot_currents()
current_path = os.path.join(file_path, f'current_sym_{f:.2f}_{london_lambda}.png')
