...
# File Info: 
    # Goals for this file: 
    #     - put in material parameters from "Superconducting, insulating and anomalous metallic regimes in a gated two-dimensional semiconductor–superconductor array" 
