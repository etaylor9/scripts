...
# Device Geometry
total_width = 30E3  # nm
total_height = 30E3 # nm 

# Device Material Parameters
thickness_film = 5  # nm
thickness_connection = 100  # nm
gamma = 1
...
coherence_length = 100 # nm 


#  --------------------------------  Create the Kagome Lattice --------------------------------  #
a = 1000  # Lattice constant
...
p1 = (points[21][0], points[21][1])
p2 = (points[24][0], points[24][1])
...
grid_res = 200  # Resolution of the grid
